...
function generate(premise, { onDelta, onDone, onError, onReset, model, effort, web, style, references }) {
...
function runTurn(systemPrompt, prompt, { model, effort, web, read } = {}) {
...
async function revise({ markdown, comments = [], instruction = '', history = [], model, effort, web, style, references }) {
  ...
  const opts = { model, effort, web, read: hasRefs };
